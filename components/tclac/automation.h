...
// Action template: change vertical louver fixation
...
// Action template: change horizontal louver fixation
...
// Action template: change vertical swing mode
...
// Action template: change horizontal swing mode
